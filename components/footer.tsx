            ...
            <div className="w-full md:block hidden ">
                <div className="w-full md:flex hidden justify-center h-20 mt-16">
                    <div className="w-1/3 flex justify-start items-center">
                        <div className="flex md:text-xl text-gray-500 text-xs">
                ...
                <div className="w-full md:flex hidden justify-center items-center mb-4">
                    <img className="w-5" src="/icons/copyright.jpg" />沪ICP备20024361号-2
                </div>
            </div>
            {/* for mobile */}
