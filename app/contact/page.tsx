        ...
        <div className="w-full pr-7 pl-7">
            ...
            <div className="mt-36 w-full">
                <div className="w-full md:flex justify-center">
                    ...
                    <div className="md:w-1/4 w-full md:flex md:text-start text-center md:text-2xl text-lg">Consult</div>
                ...
                <div className="w-full md:flex justify-center mt-16">
                    <div className="w-1/4"></div>
                    <div className="md:w-1/4 w-full md:flex md:text-start text-center md:text-2xl text-lg">Social Media</div>
                    <div className="md:w-1/2 w-full flex md:justify-start justify-center md:text-lg text-base md:mt-0 mt-4">
                        We are on&ensp;<a href="https://behance.net" className="text-gray-500">Behance</a>, <a href="https://instagram.com" className="text-gray-500">Instagram</a>, <a href="https://gtn9.com" className="text-gray-500">gtn9</a>
                    </div>
                </div>
                <div className="w-full md:flex justify-center mt-2">
                    ...
                    <div className="md:w-1/2 w-full flex md:justify-start justify-center">
                        <div className="md:w-1/2 w-full">
                            <div className="md:text-2xl text-lg w-full md:text-start text-center">微信公众号</div>
                ...
                <div className="w-full md:flex justify-center mt-20 mb-20">
                    <div className="w-1/4"></div>
                    <div className="md:w-1/4 w-full md:flex md:text-start text-center md:text-2xl text-lg">Address</div>
